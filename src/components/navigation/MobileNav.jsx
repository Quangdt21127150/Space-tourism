...
function MobileNav({ handleOverlayClick, handleMobileNavToggle }) {
  return (
    <div
      className="absolute inset-0 flex justify-end z-40"
      ...
      >
        <ul className="uppercase text-primary flex flex-col gap-8 font-secondary">
          <li>
            ...
            >
              <span className="inline-block min-w-9 font-bold">00</span>Home
            </Link>
          </li>
          <li>
            <Link
              ...
              onClick={handleMobileNavToggle}
            >
              <span className="inline-block min-w-9 font-bold">01</span>
              Destination
            </Link>
          </li>
          <li>
            <Link
              ...
              onClick={handleMobileNavToggle}
            >
              <span className="inline-block min-w-9 font-bold">02</span>Crew
            </Link>
          </li>
          <li>
            <Link
              ...
              onClick={handleMobileNavToggle}
            >
              <span className="inline-block min-w-9 font-bold">03</span>
              Technology
            </Link>
          </li>
        </ul>
